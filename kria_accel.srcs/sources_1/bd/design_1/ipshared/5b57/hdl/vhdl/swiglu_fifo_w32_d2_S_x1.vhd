...
entity swiglu_fifo_w32_d2_S_x1 is 
    generic (
...
architecture rtl of swiglu_fifo_w32_d2_S_x1 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component swiglu_fifo_w32_d2_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_swiglu_fifo_w32_d2_S_x1_ShiftReg : swiglu_fifo_w32_d2_S_x1_ShiftReg
    generic map (
...
entity swiglu_fifo_w32_d2_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end swiglu_fifo_w32_d2_S_x1_ShiftReg;

architecture rtl of swiglu_fifo_w32_d2_S_x1_ShiftReg is
