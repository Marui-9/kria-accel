...
entity swiglu_fifo_w11_d3_S is 
    generic (
...
architecture rtl of swiglu_fifo_w11_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component swiglu_fifo_w11_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 11;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_swiglu_fifo_w11_d3_S_ShiftReg : swiglu_fifo_w11_d3_S_ShiftReg
    generic map (
...
entity swiglu_fifo_w11_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 11;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end swiglu_fifo_w11_d3_S_ShiftReg;

architecture rtl of swiglu_fifo_w11_d3_S_ShiftReg is
