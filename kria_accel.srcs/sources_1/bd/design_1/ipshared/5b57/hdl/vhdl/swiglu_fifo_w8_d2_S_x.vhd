...
entity swiglu_fifo_w8_d2_S_x is 
    generic (
...
architecture rtl of swiglu_fifo_w8_d2_S_x is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component swiglu_fifo_w8_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_swiglu_fifo_w8_d2_S_x_ShiftReg : swiglu_fifo_w8_d2_S_x_ShiftReg
    generic map (
...
entity swiglu_fifo_w8_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end swiglu_fifo_w8_d2_S_x_ShiftReg;

architecture rtl of swiglu_fifo_w8_d2_S_x_ShiftReg is
